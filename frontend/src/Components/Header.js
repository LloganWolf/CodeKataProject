            ...
            <div className="row">
              ...
              {/* RECHERCHE */}
               <div className="col-md-3 col-md-offset-3 col-sm-4">
                 ...
                 <form className="form-inline">
                  ...
                  <button type="submit" className="form-control btn cb-bouton_rouge"><i class="fa fa-search" aria-hidden="true"></i></button>
                </form> 
              ...
              <div className="col-md-1 col-sm-1">
                <form /*onSubmit={this.handle_logout}*/>
                  <button id="deconnexion" type="submit" className="btn cb-bouton_rouge"><i class="fa fa-sign-out" aria-hidden="true"></i></button>
                </form>
              </div>
            </div>
          </div>
